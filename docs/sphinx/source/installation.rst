...
You can create a conda/mamba environment which incudes the python, `eccodes <https://github.com/ecmwf/eccodes-python>`_ and `xESMF <https://xesmf.readthedocs.io/en/latest/>`_ dependencies, and then install ecmean.
...
This method will allow you to have access at the most recent ecmean version but it requires a bit more of effort.
...
Then you can through the ecmean folder ::
